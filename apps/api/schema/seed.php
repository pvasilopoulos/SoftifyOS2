...
rec($insert, $rel, 'dl_helios_core', 'deal', 'Core banking portal', ['stage' => 'negotiation', 'amount' => 84000, 'closeDate' => (new DateTimeImmutable('+12 days'))->format('Y-m-d'), 'ownerId' => 'user_maria', 'probability' => 70, 'sort' => 0], [['company', 'co_helios'], ['contact', 'ct_sofia']], $now);
rec($insert, $rel, 'dl_nimbus_app', 'deal', 'Patient experience app', ['stage' => 'qualified', 'amount' => 120000, 'closeDate' => (new DateTimeImmutable('+28 days'))->format('Y-m-d'), 'ownerId' => 'user_panos', 'probability' => 45, 'sort' => 0], [['company', 'co_nimbus']], $now);
rec($insert, $rel, 'dl_aegean_fleet', 'deal', 'Fleet operating system', ['stage' => 'proposal', 'amount' => 46500, 'closeDate' => (new DateTimeImmutable('+9 days'))->format('Y-m-d'), 'ownerId' => 'user_maria', 'probability' => 55, 'sort' => 0], [['company', 'co_aegean']], $now);
rec($insert, $rel, 'dl_orion_pos', 'deal', 'POS modernization', ['stage' => 'proposal', 'amount' => 62000, 'closeDate' => (new DateTimeImmutable('+18 days'))->format('Y-m-d'), 'ownerId' => 'user_elena', 'probability' => 40, 'sort' => 1], [['company', 'co_orion']], $now);
rec($insert, $rel, 'dl_polar_brand', 'deal', 'Brand system & site', ['stage' => 'lead', 'amount' => 18000, 'closeDate' => (new DateTimeImmutable('+21 days'))->format('Y-m-d'), 'ownerId' => 'user_panos', 'probability' => 25, 'sort' => 0], [['company', 'co_polar']], $now);
rec($insert, $rel, 'dl_kite_loyalty', 'deal', 'Loyalty & ordering', ['stage' => 'lead', 'amount' => 9400, 'closeDate' => (new DateTimeImmutable('+30 days'))->format('Y-m-d'), 'ownerId' => 'user_maria', 'probability' => 20, 'sort' => 1], [['company', 'co_kite']], $now);
rec($insert, $rel, 'dl_helios_kyc', 'deal', 'Mobile KYC', ['stage' => 'won', 'amount' => 36000, 'closeDate' => (new DateTimeImmutable('-14 days'))->format('Y-m-d'), 'ownerId' => 'user_maria', 'probability' => 100, 'sort' => 0], [['company', 'co_helios']], $now);
rec($insert, $rel, 'dl_north_lost', 'deal', 'Internal wiki rebuild', ['stage' => 'lost', 'amount' => 22000, 'closeDate' => (new DateTimeImmutable('-20 days'))->format('Y-m-d'), 'ownerId' => 'user_panos', 'probability' => 0, 'sort' => 0], [['company', 'co_polar']], $now);
